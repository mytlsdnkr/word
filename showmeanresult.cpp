...
#include "ui_showmeanresult.h"

showmeanresult::showmeanresult(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::showmeanresult)
{
    //ui->setupUi(this);
}

showmeanresult::~showmeanresult()
{
    delete ui;
}
void showmeanresult::fillTable(meaningtest *a,vector<int> &order){
...
void showmeanresult::getData(meaningtest *a,vector<int> &order){
   // qDebug()<<a[0].mean;
    ui->setupUi(this);
...
void showmeanresult::on_pushButton_clicked()
{
    this->close();
}
